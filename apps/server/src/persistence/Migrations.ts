...
import Migration0026 from "./Migrations/026_BuilderHandoffTicketConsumptions.ts";
import Migration0027 from "./Migrations/027_BuilderSessionScopes.ts";
...
export const migrationEntries = [
  ...
  [26, "BuilderHandoffTicketConsumptions", Migration0026],
  [27, "BuilderSessionScopes", Migration0027],
] as const;
