...
function ChatViewContent(props: ChatViewProps) {
  ...
  const addCurrentTasksSurface = useCallback(() => {
    if (!activeThreadRef) return;
    useRightPanelStore.getState().open(activeThreadRef, "current-tasks");
  }, [activeThreadRef]);
  const addRtxOrchestratorSurface = useCallback(() => {
    if (!activeThreadRef) return;
    useRightPanelStore.getState().open(activeThreadRef, "rtx-orchestrator");
  }, [activeThreadRef]);
    ...
    const handler = (event: globalThis.KeyboardEvent) => {
      ...
      if (
        ...
        (command.startsWith("terminal.") ||
          ...
          command.startsWith("projectSearch.") ||
      ...
      >
        ...
        <div className="flex min-h-0 min-w-0 flex-1">
          ...
          >
                  ...
                  >
                    ...
                    >
                      ...
                      <div className="min-h-0">
                        ...
                        >
                          {!LLP_CHAT_ONLY_UI && showComposerContextStrip && (
            ...
            {!LLP_CHAT_ONLY_UI && activeThreadRef && activePreviewMiniPlayer ? (
            ...
            {!LLP_CHAT_ONLY_UI && pullRequestDialogState ? (
